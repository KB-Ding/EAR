...
DATA_DIR="/Data/AugWithOrign/xnli"

python3 /apdcephfs/share_1157269/karlding/EAR/run_classify.py \
--model_type $MODEL  \
--model_name_or_path "/Data/modle_card/huggingface/xlm-roberta-base" \
--train_language 'en' \
--task_name $TASK  \
--do_train  \
--do_eval  \
...
--save_steps 1000  \
--log_file "train.log"  \
--predict_languages "en,ar,bg,de,el,es,fr,hi,ru,sw,th,tr,ur,vi,zh"  \
