...
def opts(parser):
    ...
    parser.add_argument("--save_dev", action="store_true",help="save_dev")
    parser.add_argument("--bi_stream", action="store_true", help="bi-stream-dataset")
    parser.add_argument("--alpha", default=1.0, type=float, help="alpha.")
    parser.add_argument("--beta", default=1.0, type=float, help="beta.")
    parser.add_argument("--ap_layer", default=5, type=int, help="ap_layer.")
